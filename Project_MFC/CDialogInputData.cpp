...
void CDialogInputData::ModifyData()
{
	...
	pDocum->UpdateAllViews(NULL);
		...
		CExcept1App* pExcept = GetExceptPtr();
		pExcept->PutMessage(STATIC_MOD_ERROR);
	}
}
...
void CDialogInputData::OnClickedButtonAdd()
{
	...
	pExcept->PutMessage(1003);
		...
		CExcept1App* pExcept = GetExceptPtr();
		pExcept->PutMessage(STATIC_ADD_ERROR);
	}
}
...
{ try {
	...
	pDocum->UpdateAllViews(NULL);
		...
		CExcept1App* pExcept = GetExceptPtr();
		pExcept->PutMessage(STATIC_CLEAR_ERROR);
	}
}
...
void CDialogInputData::OnClickedButtonDelAll()
{
	...
	pDocum->UpdateAllViews(NULL);
		...
		CExcept1App* pExcept = GetExceptPtr();
		pExcept->PutMessage(STATIC_DELETE_ERROR);
	}
}
